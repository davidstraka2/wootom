...
export function registerTemplateVariants(): void {
    ...
    variantRegistry.setVariant('OuterEnv', 'align', 'align');
    ...
    variantRegistry.setVariant('OuterEnv', 'image', 'image');
    ...
    variantRegistry.setVariant('InnerEnv', 'item', 'item');
    ...
    variantRegistry.setVariant('InnerEnv', 'todo', 'todo');
}
